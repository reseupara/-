...
<head>
	...
	<!-- modify 용 js를 만들어서 넣어야한다. -->
	<!--<script src="/js/member/edit.js"></script>  왜 안먹힐까 -->
					...
					<div class="container" style="width: 800px; padding: 10% 5%;">
						...
						<div class="form-group" style="width:100%;">
							<label for="inputId">* 아이디</label> <br /> <input type="text"
								class="form-control" id="mbme_id" name="mbme_id" value="<c:out value="${vo.mbme_id }" />"
								readonly
						...
						<div class="form-group">
							<label for="inputName">* 이름</label> <input type="text"
								...
								value="<c:out value="${vo.mbme_name }" />"
						...
						<div class="form-group">
							<label for="inputNickName">* 닉네임</label> <input type="text"
								...
								value="<c:out value="${vo.mbme_nick }" />"
						...
						<div class="form-group">
							<label for="InputEmail">* 이메일 주소</label><br /> <input type="email"
								...
								value="<c:out value="${vo.mbme_email }" />"
						...
						<div class="form-group">
							<label for="inputMobile">* 휴대폰 번호</label> <input type="tel"
								...
								value="<c:out value="${vo.mbme_phone }" />"
						...
						<div class="form-group">
							...
							<input type="text" id="sample2_postcode" name="mbme_zipcode" class="form-control" 
								value="<c:out value="${vo.mbme_zipcode }" />"
						...
						<div class="form-group">
							...
							<label><input type="radio" name="mbme_eventre" value="Y" style="margin-left: 20px;" <c:out value="${vo.mbme_eventre == 'Y'? 'checked' : '' }"/>> 예</label>
	     					<label><input type="radio" name="mbme_eventre" value="N" style="margin-left: 20px;" <c:out value="${vo.mbme_eventre == 'N'? 'checked' : '' }"/>> 아니오</label>
						</div>
						<br>
						<button id="iddelete">계정탈퇴</button>
					</div>
